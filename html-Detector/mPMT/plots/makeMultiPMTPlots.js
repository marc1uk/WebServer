...
let plots = [
    {
       ...
       layout: {
          ...
          yaxis2: {
             ...
             range: [2.5, 4.5] // Set the range from y2_plot1
          }
       }
    },
    {
...
function gettable(command) { //generic funcion for returning SQL table
 ...
 async function getTimeDataForDevice(deviceName, time_option) {
    ...
    if (time_option === null) {
       var command = "select * from monitoring where device='" + selectedDevice + "' order by time asc limit 10";
